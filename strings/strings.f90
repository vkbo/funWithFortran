...
!
!  This module was written as a part of SixTrack
!  https://github.com/SixTrack/SixTrack
!
!  It is an implementation of a string object inspired by the one found in C++
!  It has operator overloading, and can be combined with standard Fortran character arrays
!
!  Usage
! ~~~~~~~
